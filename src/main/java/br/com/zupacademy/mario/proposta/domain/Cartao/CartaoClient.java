...
import br.com.zupacademy.mario.proposta.domain.Cartao.dto.ResultadoCarteira;
...
public interface CartaoClient {
	...
	@PostMapping(value = "/api/cartoes/{uuid}/carteiras")
	ResultadoCarteira notificaCarteira(@PathVariable String uuid, @RequestBody InclusaoCarteira carteira);
}